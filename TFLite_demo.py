...
# %% 保存 TFLite 模型
with open('feedforward_model.tflite', 'wb') as f:
    f.write(tflite_model)
print("Model saved as feedforward_model.tflite.")

# %% 加载模型（可选）
# loaded_tflite_model = tf.lite.Interpreter(model_path='feedforward_model.tflite')
