...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "feedforward_model"
...
#define AI_NETWORK_IN_1_CHANNEL     (9)
#define AI_NETWORK_IN_1_SIZE        (9)
#define AI_NETWORK_IN_1_SIZE_BYTES  (36)
