...
#define AI_NETWORK_MODEL_SIGNATURE     "db63ea7236dc1f122902e05bb73b6f5b"
...
#define AI_TOOLS_DATE_TIME   "Wed Jan  8 16:24:09 2025"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 9, 128, 1, 1), AI_STRIDE_INIT(4, 4, 36, 4608, 4608),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 38924, 1, 1),
    38924, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 220);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 220);
    ...
    dense_2_output_array.data = AI_PTR(g_network_activations_map[0] + 12);
    dense_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 12);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 4608);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4608);
    
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 5120);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 5120);
    
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 37888);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 37888);
    
    dense_2_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 38144);
    dense_2_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 38144);
    
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 38912);
    dense_2_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 38912);
